...
new_SE_ALL <- readRDS(file.path(processed_dir, 'new_SE_ALL.rds'))
new_SE_Chosen <- readRDS(file.path(processed_dir, 'new_SE_Chosen.rds'))
cell_AML <- readRDS(file.path(processed_dir, 'cell_AML.rds'))
drug_AML <- readRDS(file.path(processed_dir, 'drug_AML.rds'))
kallisto_rnaseq_all <- readRDS(file.path(processed_dir, 'kallisto_rnaseq_all.rds'))
...
info_AML <- readRDS(file.path(processed_dir, 'info_AML.rds'))
doseViabilityArray_AML <- readRDS(file.path(processed_dir, 'doseViabilityArray_AML.rds'))
profiles_AML <- readRDS(file.path(processed_dir, 'profiles_AML.rds'))
...
saveRDS(BeatAML, file = paste0(output_dir, filename))
